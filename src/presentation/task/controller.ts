...
import { CustonError } from '../../shared'; // Asumiendo que esto es un error tipográfico, debería ser 'CustomError'.
...
export class TaskController {
  ...
  getCompletedTasksByPriority = async (req: Request, res: Response) => {
    ...
    this.taskService.getCompletedTasksByPriority(paginationDto!, priority)
